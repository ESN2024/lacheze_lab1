// lacheze_lab1_sys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module lacheze_lab1_sys_mm_interconnect_0 (
		...
		output wire [1:0]  pioled_s1_address,                              //                                pioled_s1.address
		output wire        pioled_s1_write,                                //                                         .write
		input  wire [31:0] pioled_s1_readdata,                             //                                         .readdata
		output wire [31:0] pioled_s1_writedata,                            //                                         .writedata
		output wire        pioled_s1_chipselect                            //                                         .chipselect
	);
	...
	wire  [31:0] pioled_s1_agent_m0_readdata;                                                        // pioled_s1_translator:uav_readdata -> pioled_s1_agent:m0_readdata
	wire         pioled_s1_agent_m0_waitrequest;                                                     // pioled_s1_translator:uav_waitrequest -> pioled_s1_agent:m0_waitrequest
	wire         pioled_s1_agent_m0_debugaccess;                                                     // pioled_s1_agent:m0_debugaccess -> pioled_s1_translator:uav_debugaccess
	wire  [17:0] pioled_s1_agent_m0_address;                                                         // pioled_s1_agent:m0_address -> pioled_s1_translator:uav_address
	wire   [3:0] pioled_s1_agent_m0_byteenable;                                                      // pioled_s1_agent:m0_byteenable -> pioled_s1_translator:uav_byteenable
	wire         pioled_s1_agent_m0_read;                                                            // pioled_s1_agent:m0_read -> pioled_s1_translator:uav_read
	wire         pioled_s1_agent_m0_readdatavalid;                                                   // pioled_s1_translator:uav_readdatavalid -> pioled_s1_agent:m0_readdatavalid
	wire         pioled_s1_agent_m0_lock;                                                            // pioled_s1_agent:m0_lock -> pioled_s1_translator:uav_lock
	wire  [31:0] pioled_s1_agent_m0_writedata;                                                       // pioled_s1_agent:m0_writedata -> pioled_s1_translator:uav_writedata
	wire         pioled_s1_agent_m0_write;                                                           // pioled_s1_agent:m0_write -> pioled_s1_translator:uav_write
	wire   [2:0] pioled_s1_agent_m0_burstcount;                                                      // pioled_s1_agent:m0_burstcount -> pioled_s1_translator:uav_burstcount
	wire         pioled_s1_agent_rf_source_valid;                                                    // pioled_s1_agent:rf_source_valid -> pioled_s1_agent_rsp_fifo:in_valid
	wire  [94:0] pioled_s1_agent_rf_source_data;                                                     // pioled_s1_agent:rf_source_data -> pioled_s1_agent_rsp_fifo:in_data
	wire         pioled_s1_agent_rf_source_ready;                                                    // pioled_s1_agent_rsp_fifo:in_ready -> pioled_s1_agent:rf_source_ready
	wire         pioled_s1_agent_rf_source_startofpacket;                                            // pioled_s1_agent:rf_source_startofpacket -> pioled_s1_agent_rsp_fifo:in_startofpacket
	wire         pioled_s1_agent_rf_source_endofpacket;                                              // pioled_s1_agent:rf_source_endofpacket -> pioled_s1_agent_rsp_fifo:in_endofpacket
	wire         pioled_s1_agent_rsp_fifo_out_valid;                                                 // pioled_s1_agent_rsp_fifo:out_valid -> pioled_s1_agent:rf_sink_valid
	wire  [94:0] pioled_s1_agent_rsp_fifo_out_data;                                                  // pioled_s1_agent_rsp_fifo:out_data -> pioled_s1_agent:rf_sink_data
	wire         pioled_s1_agent_rsp_fifo_out_ready;                                                 // pioled_s1_agent:rf_sink_ready -> pioled_s1_agent_rsp_fifo:out_ready
	wire         pioled_s1_agent_rsp_fifo_out_startofpacket;                                         // pioled_s1_agent_rsp_fifo:out_startofpacket -> pioled_s1_agent:rf_sink_startofpacket
	wire         pioled_s1_agent_rsp_fifo_out_endofpacket;                                           // pioled_s1_agent_rsp_fifo:out_endofpacket -> pioled_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pioled_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pioled_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // pioled_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pioled_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pioled_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pioled_s1_agent:cp_endofpacket
	...
	wire  [17:0] piobp_s1_agent_m0_address;                                                          // piobp_s1_agent:m0_address -> piobp_s1_translator:uav_address
	...
	wire  [94:0] piobp_s1_agent_rf_source_data;                                                      // piobp_s1_agent:rf_source_data -> piobp_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] piobp_s1_agent_rsp_fifo_out_data;                                                   // piobp_s1_agent_rsp_fifo:out_data -> piobp_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> piobp_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // piobp_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> piobp_s1_agent:cp_channel
	...
	wire         pioled_s1_agent_rp_valid;                                                           // pioled_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] pioled_s1_agent_rp_data;                                                            // pioled_s1_agent:rp_data -> router_005:sink_data
	wire         pioled_s1_agent_rp_ready;                                                           // router_005:sink_ready -> pioled_s1_agent:rp_ready
	wire         pioled_s1_agent_rp_startofpacket;                                                   // pioled_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pioled_s1_agent_rp_endofpacket;                                                     // pioled_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [93:0] piobp_s1_agent_rp_data;                                                             // piobp_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pioled_s1_agent_rdata_fifo_src_valid;                                               // pioled_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pioled_s1_agent_rdata_fifo_src_data;                                                // pioled_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pioled_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_003:in_0_ready -> pioled_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> pioled_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> pioled_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // pioled_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> pioled_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pioled_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pioled_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (pioled_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (pioled_s1_agent_m0_read),                        //                         .read
		.uav_write              (pioled_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (pioled_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (pioled_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (pioled_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (pioled_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (pioled_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (pioled_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (pioled_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (pioled_s1_address),                              //      avalon_anti_slave_0.address
		.av_write               (pioled_s1_write),                                //                         .write
		.av_readdata            (pioled_s1_readdata),                             //                         .readdata
		.av_writedata           (pioled_s1_writedata),                            //                         .writedata
		.av_chipselect          (pioled_s1_chipselect),                           //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (pioled_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (pioled_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (pioled_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (pioled_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (pioled_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (pioled_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (pioled_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (pioled_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (pioled_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (pioled_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (pioled_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (pioled_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (pioled_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (pioled_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (pioled_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (pioled_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (pioled_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (pioled_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (pioled_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (pioled_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (pioled_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (pioled_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (pioled_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (pioled_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (pioled_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (pioled_s1_agent_rf_source_data),                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),              //                .error
		.rdata_fifo_src_ready    (pioled_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pioled_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (pioled_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pioled_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pioled_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (pioled_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (pioled_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (pioled_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (pioled_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (pioled_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (pioled_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (pioled_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (pioled_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (pioled_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	lacheze_lab1_sys_mm_interconnect_0_router router (
	...
	lacheze_lab1_sys_mm_interconnect_0_router_001 router_001 (
	...
	lacheze_lab1_sys_mm_interconnect_0_router_002 router_002 (
	...
	lacheze_lab1_sys_mm_interconnect_0_router_003 router_003 (
	...
	lacheze_lab1_sys_mm_interconnect_0_router_003 router_004 (
	...
	lacheze_lab1_sys_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (pioled_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (pioled_s1_agent_rp_valid),                       //          .valid
		.sink_data          (pioled_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (pioled_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (pioled_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_router_002 router_006 (
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lacheze_lab1_sys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	lacheze_lab1_sys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pioled_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (pioled_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (pioled_s1_agent_rdata_fifo_src_ready),           //         .ready
